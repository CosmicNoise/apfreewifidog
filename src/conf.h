...
#define DEFAULT_MQTT_SERVER		"192.168.1.207"
...
typedef struct {
	...
	int origin; /* using original wifidog protocol or not */
	int wechat; /* using wechat authenticate depend on origin:0 */
	int web; /* using web authenticate depend on origin:0 */
	int ad; /* using ad authenticate depend on origin:0 */
